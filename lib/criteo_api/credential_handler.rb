...
module CriteoApi
  class CredentialHandler < Shampoohat::CredentialHandler
    ...
    def generate_user_agent(extra_ids = [])
      ...
      extra_ids << ['AwApi-Ruby/%s' % CriteoApi::ApiConfig::CLIENT_LIB_VERSION]
